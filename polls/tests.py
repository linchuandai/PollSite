...
#To test: python manage.py test 'app name'
...
class QuestionMethodTest(TestCase):
    ...
    def test_was_published_recently_with_recenty_question(self):
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        ...
        self.assertQuerysetEqual(response.context['latest_question_set'], [])
